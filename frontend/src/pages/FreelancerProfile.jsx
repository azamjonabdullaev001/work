...
import { getProfile, getUserReviews } from '../api/api';
import { FiStar, FiMapPin, FiDollarSign, FiExternalLink, FiCalendar } from 'react-icons/fi';
              ...
              <div className="profile-hero-top">
                ...
                <div className="profile-hero-info">
                  ...
                  <div className="profile-meta">
                    {profile.rating > 0 && (
                      <span className="rating"><FiStar className="star-filled" /> {profile.rating?.toFixed(1)} ({profile.reviews_count} отзывов)</span>
                    )}
